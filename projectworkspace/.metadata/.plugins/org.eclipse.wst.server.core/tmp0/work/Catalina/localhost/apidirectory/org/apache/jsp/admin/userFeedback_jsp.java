 ...
 * Generated at: 2022-02-28 07:25:23 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t<h3 class=\"card-title\">File a feedback</h3>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<hr><br>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t              <div class=\"card\">\r\n");
      out.write("\t\t\t\t\t\t\t\t                <div class=\"card-body\">\t\t\t\t\t\t\t\t                  \r\n");
      out.write("\t\t\t\t\t\t\t\t                  <p class=\"card-description\">Rate us</p>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<label for=\"maxlength-textarea\">Comments</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<textarea id=\"maxlength-textarea\" class=\"form-control\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tmaxlength=\"750\" rows=\"5\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"This textarea has a limit of 750 chars.\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
