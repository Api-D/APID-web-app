 ...
 * Generated at: 2022-02-28 09:01:44 UTC
...
public final class addComplainReply_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t<h4 class=\"card-title\">Complain Reply</h4>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"name\" minlength=\"2\" type=\"text\" readonly>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<label for=\"ccomment\">Reply</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<textarea id=\"ccomment\" class=\"form-control\" name=\"comment\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\trequired></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input class=\"btn btn-primary\" type=\"submit\" value=\"Reply\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</fieldset>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
