 ...
 * Generated at: 2022-02-28 06:53:30 UTC
...
public final class adminfeedbacks_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<label for=\"cname\">Overall Feedback</label> <input id=\"cname\" class=\"form-control\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"name\" minlength=\"2\" type=\"text\" required>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<label for=\"ccomment\">Description</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<textarea id=\"omment\" class=\"form-control\" name=\"coment\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\trequired></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<label for=\"ccomment\">Your Reply (required)</label>\r\n");
