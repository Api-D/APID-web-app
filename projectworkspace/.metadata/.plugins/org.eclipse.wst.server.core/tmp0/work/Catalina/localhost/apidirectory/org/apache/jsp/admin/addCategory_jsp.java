 ...
 * Generated at: 2022-02-28 09:23:17 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"background: linear-gradient(91deg, #7571f9, transparent);\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<h3 class=\"m-0 text-white\">Add Category</h3>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"card-body\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<form class=\"cmxform\" id=\"commentForm\" method=\"get\" action=\"#\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<fieldset>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<label for=\"cname\">Category Name</label> <input id=\"cname\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"form-control\" name=\"name\" minlength=\"2\" type=\"text\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\trequired>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<label for=\"ccomment\">Category Description</label>\r\n");
