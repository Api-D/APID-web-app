 ...
 * Generated at: 2022-02-28 08:06:17 UTC
...
public final class managefeedbacks_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("<title>Manage Feedback</title>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<h4 class=\"card-title\">Feedbacks</h4>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>ahiraniket@outlook.in</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<select id=\"example-css\" name=\"rating\" autocomplete=\"off\">\r\n");
      out.write("\t\t\t\t\t\t\t\t                    \t<option value=\"1\" selected disabled>1</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t                    \t<option value=\"2\" selected disabled>2</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t                    \t<option value=\"3\" selected disabled>3</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t                    \t<option value=\"4\" selected disabled>4</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t                    \t<option value=\"5\">5</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t                  </select>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>In publishing and graphic design, Lorem ipsum is a placeholder text \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"\">\r\n");
