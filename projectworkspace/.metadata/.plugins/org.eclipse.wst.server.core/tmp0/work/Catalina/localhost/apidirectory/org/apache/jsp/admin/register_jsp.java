 ...
 * Generated at: 2022-02-28 06:07:03 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t<h6 class=\"font-weight-light\">Signing up is easy. It only\r\n");
      out.write("\t\t\t\t\t\t\t\ttakes a few steps</h6>\r\n");
      out.write("\t\t\t\t\t\t\t<form class=\"pt-3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control form-control-lg\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tid=\"exampleInputUsername1\" placeholder=\"First Name\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control form-control-lg\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tid=\"exampleInputUsername1\" placeholder=\"Last Name\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"number\" class=\"form-control form-control-lg\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tid=\"exampleInputUsername1\" placeholder=\"Contact\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<select class=\"form-control form-control-lg\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tid=\"exampleFormControlSelect2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option selected disabled>Designation</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option>Developer</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option>Student</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option>Freelancer</option>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\ttype=\"checkbox\" class=\"form-check-input\"> I agree to\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tall Terms & Conditions\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
