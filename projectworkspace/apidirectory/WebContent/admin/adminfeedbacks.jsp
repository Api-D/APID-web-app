									...
									<form class="cmxform" id="commentForm" method="get" action="#">
										<fieldset>
											<div class="form-group">
												<label for="cname">Overall Feedback</label> <input id="cname" class="form-control"
													name="name" minlength="2" type="text" required>
											</div>
											<div class="form-group">
												<label for="ccomment">Description</label>
												<textarea id="omment" class="form-control" name="coment"
													required></textarea>
											</div>
											<div class="form-group">
												<label for="ccomment">Your Reply (required)</label>
