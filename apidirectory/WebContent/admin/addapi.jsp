				...
				<div class="content-wrapper">
					<div class="row grid-margin">
						<div class="col-lg-12">
							<div class="card">
								<div class="card-body">
									<h4 class="card-title">Request a new Api</h4>
									<form class="cmxform" id="commentForm" method="get" action="#">
										<fieldset>
											<div class="form-group">
												<label for="cname">Domain Name</label> 
												<input id="cname" class="form-control"
												 name="name" minlength="2" type="text" required>
											</div>
											
											<div class="form-group">
												<label for="cname">Api Name</label> 
												<input id="cname" class="form-control"
													name="name" minlength="2" type="text" required>
											</div>
											
											<div class="form-group">
											<label for="cname">API Type</label> 
											...
											<div class="form-group">
											<label for="cname">Request Method Type</label> 
                 							<select class="form-control " id="exampleFormControlSelect2">
											...
											<div class="form-group">
												<label for="cname">Api Endpoint</label> 
												<input id="cname" class="form-control"
													name="name" minlength="2" type="text" required>
											</div>
											...
											<div class="form-group">
											<label for="cname">Request Type</label> 
                 							<select class="form-control " id="exampleFormControlSelect2">
                 								<option disabled class="nav-item">Select Request Type</option>
											...
											<div class="form-group">
											<label for="cname">Response Type</label> 
                 							<select class="form-control " id="exampleFormControlSelect2">
                 								<option disabled class="nav-item">Select Response Type</option>
                 								<option  class="nav-item">XML</option>
                 								<option  class="nav-item">JSON</option>
                						 	</select>
											</div>
											...
											<div class="form-group">
												<label for="cname">Sample Request</label> 
												<input id="cname" class="form-control"
													name="name" minlength="2" type="text" required>
											</div>
											
											<div class="form-group">
												<label for="cname">Sample Response</label> 
												<input id="cname" class="form-control"
													name="name" minlength="2" type="text" required>
											</div>
